...
const SPECS: Spec[] = [
  { first: 'Hannah', last: 'Müller', email: 'hannah.muller@example.de', phone: '+49 30 1234567', country: 'DE', types: ['Access'], jurisdiction: 'GDPR (EU/EEA)', channel: 'Email', status: 'Email Response Sent', priority: 'High', risk: 'Medium', daysAgo: 40, ownerIdx: 0, relationship: 'Customer', businessUnit: 'Customer Support', description: 'Requesting a copy of all personal data held, including support tickets and marketing profiles.' },
  { first: 'Marcus', last: 'Lee', email: 'marcus.lee@example.com', phone: '+1 415 555 0132', country: 'US', types: ['Deletion'], jurisdiction: 'CCPA/CPRA (California)', channel: 'Web Form', status: 'Email Ron K.', priority: 'High', risk: 'High', daysAgo: 40, ownerIdx: null, relationship: 'Customer', businessUnit: 'Marketing', description: 'Requests deletion of account and all associated marketing and analytics data.' },
  { first: 'Sofia', last: 'Rossi', email: 'sofia.rossi@example.it', country: 'IT', types: ['Access', 'Unsubscribe'], jurisdiction: 'GDPR (EU/EEA)', channel: 'Email', status: 'Follow-up Email Sent', priority: 'Medium', risk: 'Medium', daysAgo: 10, ownerIdx: 0, relationship: 'Customer', businessUnit: 'Sales', description: 'Access to order history and removal from all marketing mailing lists.' },
  ...
  { first: 'Amara', last: 'Singh', email: 'amara.singh@example.com', country: 'CA', types: ['Unsubscribe'], jurisdiction: 'GDPR (EU/EEA)', channel: 'Web Form', status: 'Closed', priority: 'Medium', risk: 'Low', daysAgo: 25, ownerIdx: 0, relationship: 'Customer', businessUnit: 'Marketing', description: 'Unsubscribe from all marketing communications and newsletters.' },
  ...
  { first: 'Grace', last: 'Chen', email: 'grace.chen@example.com', country: 'US', types: ['Do Not Sale'], jurisdiction: 'CCPA/CPRA (California)', channel: 'Web Form', status: 'Email Response Sent', priority: 'Low', risk: 'Low', daysAgo: 10, ownerIdx: null, relationship: 'Customer', businessUnit: 'Marketing', description: 'Opt out of the sale and sharing of personal information.' },
  { first: 'Noah', last: 'Weber', email: 'noah.weber@example.de', country: 'DE', types: ['Do Not Sale'], jurisdiction: 'GDPR (EU/EEA)', channel: 'Email', status: 'Email Ron K.', priority: 'High', risk: 'High', daysAgo: 15, ownerIdx: 0, relationship: 'Customer', businessUnit: 'Legal', description: 'Do-not-sell request covering profiling and data brokerage activities.' },
